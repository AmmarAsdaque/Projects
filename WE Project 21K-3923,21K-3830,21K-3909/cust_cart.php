                            ...
                            <li
                                ...
                                <div class="ms-3 mt-3 me-auto">
                                    <div class="fw-normal"><span class="h5"><?php echo $row["ct_amount"]?>x</span>
                                        <?php echo $row["f_name"]?>
                                        <p><?php printf("%.2f PKR <small class='text-muted'>(%.2f PKR each)</small>",$row["f_price"]*$row["ct_amount"],$row["f_price"])?><br />
                    ...
                    <form method="POST" action="add_order.php">
                        ...
                        <div class="col">
                            ...
                            <?php }else{ ?>
                                    ...
                                    <button type="submit" class="w-100 btn btn-primary" name="place_order" id="place_order">Proceed</button>
                            <?php } ?>
                        </div>
                    </form>
                </div>
